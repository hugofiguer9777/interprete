...
def p_if_else_instr(t) :
    'if_instr      : IF PARIZQ expresion_logica PARDER LLAVIZQ instrucciones LLAVDER ELSE LLAVIZQ instrucciones LLAVDER'
    t[0] =IfElse(t[3], t[6], t[10])

def p_if_elseif_instr(t) :
    'if_instr       : IF PARIZQ expresion_logica PARDER LLAVIZQ instrucciones LLAVDER ELSE if_instr'
    t[0] = IfElseIf(t[3], t[9], t[6])

def p_funcion_instr(t) :
    'funcion_instr      : ID PARIZQ lista_parametros PARDER LLAVIZQ instrucciones LLAVDER'
    t[0] = Funcion(t[1], t[3], t[6])

def p_funcion_sinpar_instr(t) :
    'funcion_instr      : ID PARIZQ PARDER LLAVIZQ instrucciones LLAVDER'
    t[0] = Funcion(t[1], [], t[5])
...
def p_llamada_instr(t) :
    'llamada_instr      : ID PARIZQ lista_parametros_exp PARDER PTCOMA'
    t[0] = LlamadaFuncion(t[1], t[3])

def p_llamada_sinpar_instr(t) :
    'llamada_instr      : ID PARIZQ PARDER PTCOMA'
    t[0] = LlamadaFuncion(t[1], [])

def p_lista_parametros_exp(t) :
    'lista_parametros_exp   : lista_parametros_exp COMA expresion_numerica'
    t[1].append(t[3])
    t[0] = t[1]

def p_parametros_exp(t) :
    'lista_parametros_exp   : expresion_numerica'
    t[0] = [t[1]]

def p_retorno_instr(t) :
    'retorno_instr           : RETORNO expresion_numerica PTCOMA'
    t[0] = Retorno(t[2])

def p_retorno_sin_instr(t) :
    'retorno_instr           : RETORNO PTCOMA'
    t[0] = Retorno(None)
...
def p_expresion_funcion(t) :
    'expresion_numerica     : ID PARIZQ lista_parametros_exp PARDER'
    t[0] = ExpresionFuncion(t[1], t[3])

def p_expresion_funcion_sinpar(t) :
    'expresion_numerica     : ID PARIZQ PARDER'
    t[0] = ExpresionFuncion(t[1], [])
